...
type Data1Events = ReturnType<typeof useEventType1Events>;

const formToEvent = (data: EventType1Form) => {
...
export const EventType1Popup = ({ dataControls, ...props }: Data1PopupProps) => {
  ...
  const [originalEvents, { addEvent, updateEvent, deleteEvent }] = useContext(EventType1Context);
